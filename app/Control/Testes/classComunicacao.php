<?php
	...
	class Comunicacao
	{
	    ...
	    private $palavrasChavesParaExibirExemplos = array();
	   	...
	   	private $palavrasChavesParaConsultarTarefasAnteriores = array();
	   	private $palavrasChavesParaConsultarTarefasPosteriores = array();
	    ...
	    private function interacao_para_exibir_todas_tarefas($mensagem){
	    	...
	    	if($this->verificarValoresIguais($arrayMsg, $this->palavrasChavesParaComandos) and $this->verificarValoresIguais($arrayMsg, $this->palavrasChavesParaExibirTodasAsTarefas) and $this->verificarValoresIguais($arrayMsg,$this->palavraTarefa)){
	    		return "Solictou todas as tarefas";
	    	};
	    }
		...
		private function extrair_dados($string, $campos = "") { //campos ex.: array('nome', 'descricao', 'prazo');//
		...
		private function verificaAcaoDesejada($mensagem){			
		...
		private function carregar_Arquivos(){		        
			$this->chavesArray = array(
    			...
    			"chavesParaConsultarAntes" => "anterior, anteriores, antes",
    			"chavesParaConsultarDepois" => "posterior, posteriores, depois"
		...
		{				
				...
				if($this->verifica_qnt_acoes($msg) <= 1 ){
					echo $this->verificaAcaoDesejada($msg);		
				}else
					echo "Posso apenas realizar um tarefa por vez!!!";				
		}
	}	
?>